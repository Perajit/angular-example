...
describe('PokemonFormComponent', () => {
  ...
  describe('#onSubmit()', () => {
    ...
    describe('when pokemon form is valid', () => {
      ...
      beforeEach(() => {
        component.pokemonForm.controls.name.setValue(pokemonData.name);
        component.pokemonForm.controls.class.setValue(pokemonData.class);
        component.pokemonForm.controls.cp.setValue(pokemonData.cp);
      });
      ...
      it('should emit savePokemon event', () => {
        ...
        expect(component.savePokemon.emit).toHaveBeenCalledWith({ data: pokemonData });
      });
    });
